    ...
    <form id="formulario" action="{{ route('cliente.insertar') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="bg-white rounded-lg shadow-lg p-4">
                    ...
                    <div class="mt-10">
                        <div class="grid gap-6 mb-6 md:grid-cols-2 mt-10">
                            <div>
                                <label for="nombreUsuarioCliente"
                                    class="block mb-2 text-sm font-medium text-gray-900">Nombre Cliente</label>
                                <input type="text" name="nombreUsuarioCliente" id="nombreUsuarioCliente"
                            ...
                            <div>
                                <label for="contraseñaCliente"
                                    class="block mb-2 text-sm font-medium text-gray-900">Contraseña Cliente</label>
                                <input type="text" name="contraseñaCliente" id="contraseñaCliente"
                                    class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"
                                    placeholder="" required>
                            </div>
                        </div>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2 mt-10">
                        ...
                        <div>
                            <label for="apellidoPaterno" class="block mb-2 text-sm font-medium text-gray-900">Apellido
                                Paterno</label>
                        ...
                        <div>
                            <label for="apellidoMaterno" class="block mb-2 text-sm font-medium text-gray-900">Apellido
                                Materno</label>
                        ...
                        <div>
                            <label for="estatusPatron" class="block mb-2 text-sm font-medium text-gray-900">Estatus del
                                patrón</label>
                            <select name="estatusPatron" id="estatusPatron"
                                class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5">
                        ...
                        <div>
                            <label for="fecha_inicio_operaciones"
                                class="block mb-2 text-sm font-medium text-gray-900">Fecha de inicio de
                                operaciones</label>
                            <input type="date" name="fecha_inicio_operaciones" id="fecha_inicio_operaciones"
                                class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"
                                required>
                        </div>
                        <div>
                            <label for="fecha_ultimo_cambio_de_estado"
                                class="block mb-2 text-sm font-medium text-gray-900">Fecha de último cambio de
                                estado</label>
                            <input type="date" name="fecha_ultimo_cambio_de_estado"
                                id="fecha_ultimo_cambio_de_estado"
                                class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2 mt-10">
                        <div>
                            <label for="codigoPostal" class="block mb-2 text-sm font-medium text-gray-900">Código
                                Postal</label>
                        ...
                        <div>
                            <label for="tipoViabilidad" class="block mb-2 text-sm font-medium text-gray-900">Tipo
                                Viabilidad</label>
                            <input type="text" name="tipoViabilidad" id="tipoViabilidad"
                                class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"
                                placeholder="" required>
                        </div>
                        <div>
                            <label for="nombreViabilidad" class="block mb-2 text-sm font-medium text-gray-900">Nombre
                                de Viabilidad</label>
                            <input type="text" name="nombreViabilidad" id="nombreViabilidad"
                                class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"
                                placeholder="" required>
                        </div>
                        <div>
                            <label for="numeroInterior" class="block mb-2 text-sm font-medium text-gray-900">Número
                                interior</label>
                        ...
                        <div>
                            <label for="localidad"
                                class="block mb-2 text-sm font-medium text-gray-900">Localidad</label>
                        ...
                        <div>
                            <label for="municipio"
                                class="block mb-2 text-sm font-medium text-gray-900">Municipio</label>
                        ...
                        <div>
                            <label for="entidadFederativa"
                                class="block mb-2 text-sm font-medium text-gray-900">Entidad Federativa</label>
                            <input type="text" name="entidadFederativa" id="entidadFederativa"
                                class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"
                                placeholder="" required>
                        </div>
                        <div>
                            <label for="entreCalle" class="block mb-2 text-sm font-medium text-gray-900">Entre
                                Calle</label>
                        ...
                        <div>
                            <label for="correoElectronico" class="block mb-2 text-sm font-medium text-gray-900">Correo
                                Electrónico</label>
        ...
        <div class="bg-white rounded-lg shadow-lg mt-10">
            ...
            <div class="bg-white rounded-lg shadow-lg mt-10">
                    ...
                    <tbody>
                        @foreach ($datosCompañias as $dato)
                            <tr class="h-20">
                                ...
                                <td class="items-center flex justify-center">
                                    <div class="mt-2 md:mt-5">
                                        <input type="checkbox" name="compañia-seleccionado"
                                            class="seleccionar-compañia" data-persona-id="{{ $dato->pkCompañia }}"
                                            class="w-6 h-6 rounded text-green-400 bg-gray-100 border-gray-300 focus:ring-green-400 focus:ring-2">
                                    </div>
                                </td>
                            </tr>
                ...
                <table class="w-full table-auto mt-[1rem]" id="compañia-lista" class="display nowrap"
                    width="90%">
                    <thead class="text-center">
                        <tr class="h-24 text-center">
                            <td>ID</td>
                ...
                <label class="block mb-2 text-sm font-medium text-gray-900" for="firmaElectronica">Carga
                    Firma-E</label>
                <input name="firmaElectronica"
                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-green-50 focus:outline-none"
                    aria-describedby="file_input_help" id="firmaElectronica" type="file">
        ...
        $(document).ready(function() {
            ...
            function actualizarCamposOcultos() {
                ...
                tableCompañiasSeleccionados.rows().every(function() {
                    ...
                    var compañiaId = data[0];
                    $('#formulario').append(
                    `<input type='hidden' name='compañia[]' value='${compañiaId}'>`);
                });
                ...
                fileInputs.forEach(function(inputName) {
                    ...
                    if (fileInput.files.length > 0) {
                        $('#formulario').append(
                            `<input type='hidden' name='${inputName}' value='${fileInput.files[0].name}'>`
                            );
                    }
                });
                ...
                for (var i = 0; i < documentosInput.files.length; i++) {
                    $('#formulario').append(
                        `<input type='hidden' name='documentos[]' value='${documentosInput.files[i].name}'>`);
                }
            }
