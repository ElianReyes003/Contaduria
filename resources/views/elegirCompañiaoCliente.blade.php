...
<body>
    <div>
        <div>Selecciona  Cliente moral o cliente fisico para {{ $empleado->nombre. ' '. $empleado->apellidoPaterno . ' ' . $empleado->apellidoMaterno  }}</div>    
    </div>

    

    <form id="formulario" action="{{ route('empleadoSeleccionarClienteCompañia.agregar') }}" enctype="multipart/form-data" method="POST">
    @csrf
