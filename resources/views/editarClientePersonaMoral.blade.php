...
<body>
    ...
    <form id="formulario" action="{{ route('personaMoral.actualizar') }}" enctype="multipart/form-data" method="post">
    @csrf
    <div class="p-4 sm:ml-64 mt-16 md:mt-10">
        ...
        <div class="p-4">
            ...
            <div class="bg-white rounded-lg shadow-lg p-4">
                ...
                <input type="hidden" name="pkCompañia"  class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" placeholder=""  value="{{$datoPersonaMoral->pkCompañia}}" required>
                 
                    <div>
                        <label for="rfc" class="block mb-2 text-sm font-medium text-gray-900">RFC</label>
                        <input type="text" name="rfc" id="rfc" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" placeholder=""  value="{{$datoPersonaMoral->rfc}}" required>
                    </div>
                    <div>
                        <label for="curp" class="block mb-2 text-sm font-medium text-gray-900">Denominacion Fiscal</label>
                        <input type="text" name="denominacion" id="denominacion" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->denominacion}}"  placeholder="" required>
                    </div>

                    <div>
                        <label for="curp" class="block mb-2 text-sm font-medium text-gray-900">Regimen Capital</label>
                        <input type="text" name="regimenCapital" id="denominacion" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->regimenCapital}}" placeholder="" required>
                    </div>

                    <div>
                        <label for="curp" class="block mb-2 text-sm font-medium text-gray-900">Nombre Comercial</label>
                        <input type="text" name="nombreComercial" id="denominacion" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"  value="{{$datoPersonaMoral->nombreComercial}}"  placeholder="" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="estatusPatron" id="estatusPatron" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5">
                            <option value="1" {{ $datoPersonaMoral->estatusPatron == 1 ? 'selected' : '' }}>Activo</option>
                            <option value="2" {{ $datoPersonaMoral->estatusPatron == 2 ? 'selected' : '' }}>Inactivo</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="date" name="fechaOperaciones" id="fecha_inicio_operaciones" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->fechaOperaciones}}" required>
                    </div>
                    <div>
                        ...
                        <input type="date" name="fechaCambioEstado" id="fecha_ultimo_cambio_de_estado" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->fechaCambioEstado}}" required>
                    </div>
                </div>
                <div class="flex justify-center mt-5 md:mt-10">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 mt-10">
                    <div>
                        ...
                        <input type="text" name="codigoPostal" id="codigoPostal" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->codigoPostal}}" placeholder="" required>
                    </div>
                    <div>
                        <label for="tipoViabilidad" class="block mb-2 text-sm font-medium text-gray-900">Tipo Viabilidad</label>
                        <input type="text" name="tipoViabilidad" id="tipoViabilidad" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->tipoViabilidad}}" placeholder="" required>
                    </div>
                    <div>
                        <label for="nombreViabilidad" class="block mb-2 text-sm font-medium text-gray-900">Nombre de Viabilidad</label>
                        <input type="text" name="nombreViabilidad" id="nombreViabilidad" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->nombreViabilidad}}" placeholder="" required>
                    </div>
                    <div>
                        <label for="numeroInterior" class="block mb-2 text-sm font-medium text-gray-900">Número interior</label>
                        <input type="text" name="numeroInterior" id="numeroInterior" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"   value="{{$datoPersonaMoral->numeroInterior}}" placeholder="" required>
                    </div>
                    <div>
                        <label for="colonia" class="block mb-2 text-sm font-medium text-gray-900">Colonia</label>
                        <input type="text" name="colonia" id="colonia" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->colonia}}"  placeholder="" required>
                    </div>
                    <div>
                        <label for="localidad" class="block mb-2 text-sm font-medium text-gray-900">Localidad</label>
                        <input type="text" name="localidad" id="localidad" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->localidad}}"  placeholder="" required>
                    </div>
                    <div>
                        <label for="municipio" class="block mb-2 text-sm font-medium text-gray-900">Municipio</label>
                        <input type="text" name="municipio" id="municipio" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->municipio}}"  placeholder="" required>
                    </div>
                    <div>
                        <label for="entidadFederativa" class="block mb-2 text-sm font-medium text-gray-900">Entidad Federativa</label>
                        <input type="text" name="entidadFederativa" id="entidadFederativa" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5" value="{{$datoPersonaMoral->entidadFederativa}}"  placeholder="" required>
                    </div>
                    <div>
                        <label for="entreCalle" class="block mb-2 text-sm font-medium text-gray-900">Entre Calle</label>
                        <input type="text" name="entreCalle" id="entreCalle" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"  value="{{$datoPersonaMoral->entreCalle}}"  placeholder="" required>
                    </div>
                    <div>
                        <label for="yCalle" class="block mb-2 text-sm font-medium text-gray-900">Y Calle</label>
                        <input type="text" name="yCalle" id="yCalle" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"  value="{{$datoPersonaMoral->yCalle}}" placeholder="" required>
                    </div>
                    <div>
                        <label for="correoElectronico" class="block mb-2 text-sm font-medium text-gray-900">Correo Electrónico</label>
                        <input type="text" name="correoElectronico" id="correoElectronico" class="bg-green-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-400 focus:border-green-400 block w-full p-2.5"  value="{{$datoPersonaMoral->correoElectronico}}" placeholder="" required>
                    </div>
                </div>
            </div>
        </div>
